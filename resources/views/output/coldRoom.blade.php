...
<div class="logbook-container">
    <header>
        ...
        <h2>COLD ROOM (STORAGE) LOGBOOK</h2>
    </header>
    <div class="logbook-table-section">
        <table class="print-table">
            ...
            <tr>
                ...
                <th class="tb-hd">Blast Freezer (°C)</th>
                <th class="tb-hd">Cold Room Temp (°c)</th>
                <th class="tb-hd">Transferred by</th>
            ...
            <tr>
                ...
                <td class="tdd">{{ $record->blast_freezer }}</td>
                <td class="tdd">{{ $record->cold_room_temp }}</td>
                <td class="tdd">{{ $record->transferredBy->name }}</td>
