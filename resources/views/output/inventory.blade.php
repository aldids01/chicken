...
<div class="logbook-container">
    <header>
        ...
        <h2>MATERIAL INVENTORY CHECKLIST</h2>
    ...
    <div class="logbook-table-section">
        <table class="print-table">
            ...
            <tr>
                ...
                <th class="tb-hd">Items</th>
                <th class="tb-hd">Available Quantity</th>
            ...
            @foreach($record->items as $item)
                <tr>
                    ...
                    <td class="tdd">{{ $item->item->name }}</td>
                    <td class="tdd">{{ $item->available_quantity }}</td>
            ...
            <tfoot>
                <tr>
                    <th class="tb-hd">Total</th>
                    <td class="tdd"></td>
                    <td class="tdd">{{ $record->total }}</td>
                    <td class="tdd"></td>
                </tr>
            </tfoot>
        </table>
